...
class Tela(ctk.CTk):
    ...
    def criar_tela_login(self):
        ...
        self.texto_de_boas_vindas = ctk.CTkLabel(self, text="Seja Bem Vindo", font=('Century Gothic bold', 32), text_color="#FF0000")
        self.texto_de_boas_vindas.grid()

        self.ver_usuario = ctk.CTkEntry(self, placeholder_text="Usuário", justify="center", border_width=3, border_color="black",
                                        font=('Century Gothic bold', 32), width=250, height=40, corner_radius=45)
        ...
        self.ver_senha = ctk.CTkEntry(self, placeholder_text="Senha", justify="center", width=250, height=40,
                                      font=('Century Gothic bold', 32), corner_radius=45, border_width=3, border_color="black", show="*")
        ...
        self.mostrar_senha = ctk.CTkCheckBox(
            ...
            border_color="black", border_width=3, command=self.mostrar_senhas)
        ...
        self.botao_entrar = ctk.CTkButton(self.frame_botoes, text="Entrar", width=50, height=50, corner_radius=70,
                                          font=('Century Gothic bold', 32), fg_color="white", text_color="gray")
        ...
        def criar_tela_cadastro(self):
            ...
            self.botao_criar_conta = ctk.CTkButton(self.frame_botoes, text="Criar conta",
            ...
            self.botao_voltar = ctk.CTkButton(self.frame_botoes, command=self.criar_tela_login, text="Voltar",
                                              font=("Century Gothic bold", 30), corner_radius=460)
